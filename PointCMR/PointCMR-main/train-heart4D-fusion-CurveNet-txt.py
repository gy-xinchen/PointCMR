...
def train_one_epoch(model, Model_3Dphase, criterion, criterion_phase, optimizer, optimizer_phase, lr_scheduler, scheduler_phase, data_loader, device, epoch, print_freq):
    ...
    for clip, target, phase, index, subject_index in metric_logger.log_every(data_loader, print_freq, header):
        ...
        output = model(clip, normalized_features)
...
def parse_args():
    ...
    parser.add_argument('--model', default='PSTTransformerFusionTxt', type=str, help='model')
    # input
    ...
    parser.add_argument('--lr_phase', type=float, default=0.001, metavar='LR',
    ...
    parser.add_argument('--output-dir', default=r'/root/autodl-tmp/dataword/PST_CurveNet4096_txt', type=str, help='path where to save')
    # resume
